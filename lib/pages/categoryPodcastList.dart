...
class categoryPodcastList extends StatefulWidget {
  final String name;

  categoryPodcastList({Key? key, required this.name}) : super(key: key);

  @override
  _categoryPodcastListState createState() => _categoryPodcastListState();
}

class _categoryPodcastListState extends State<categoryPodcastList> {
                                    ...
                                    GestureDetector(
                                      onTap: (){
                                        Navigator.of(context).push(MaterialPageRoute(
                                          builder: (context) => infoPage(id: podcast![index]['_id'].toString(),name: podcast![index]['title'].toString()),
                                        ));
                                      },
                                      child: ListTile(
                                        leading: Container(
