...
class _playerPageState extends State<playerPage> {
  ...
  Future printValue() async{
    var response = await http.get(Uri.parse('http://192.168.43.128:5000/audioBook/${widget.value}'));
  ...
  Future printEpisode() async{
    var response = await Dio().get('http://192.168.43.128:5000/chapter/${widget.value}/chapter/${widget.epi}');
